...
class TgwOutPutFile():
    def __init__(self,dir):
        ...
        self.query_order_snapshot_writer = None
        self.query_order_broker_snapshot_writer = None
        ...
        try:
            if(self.push_index_snapshot_writer == None):
                ...
                title = "market_type, security_code, orig_time, trading_phase_code, pre_close_index, " + \
                        ...
                        "total_volume_trade, total_value_trade, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                        ...
                        str(data.total_volume_trade)+ "," + str(data.total_value_trade) + "," + str(data.variety_category) + "\n"
        ...
        try:
            if(self.push_option_snapshot_writer == None):
                ...
                title = "market_type, security_code, orig_time, trading_phase_code, total_long_position, " + \
                    ...
                    "underlying_security_code, exercise_price, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                        ...
                        str(data.expire_date)+ "," + str(data.underlying_security_code)+ "," + \
                        str(data.exercise_price) + "," + str(data.variety_category)+ "\n"
        ...
        try:
            if(self.push_hkt_snapshot_writer == None):
                ...
                title = "market_type, security_code, orig_time, trading_phase_code, total_volume_trade, " + \
                        ...
                        "offer_price_limit_up, offer_price_limit_down, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                        ...
                        str(data.offer_price_limit_up) + "," + str(data.offer_price_limit_down) + "," + str(data.variety_category)+ "\n"
        ...
        try:
            if(self.push_csiindex_snapshot_writer == None):
                ...
                title = "market_type, index_market, security_code, orig_time, last_index, open_index, " + \
                        ...
                        "total_volume_trade, total_value_trade, exchange_rate, currency_symbol, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.index_market)+ "," + str(data.security_code)+ "," + \
                        ...
                        str(data.currency_symbol)+ "," + str(data.variety_category)+ "\n"
        ...
        try:
            if(self.push_hktreal_limit_writer == None):
                ...
                title = "market_type, orig_time, threshold_amount, " + \
                        "pos_amt, amount_status, mkt_status, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.orig_time)+ "," + str(data.threshold_amount)+ "," + \
                        ...
                        str(data.mkt_status)+ "," + str(data.variety_category)+ "\n"
        ...
        try:
            if(self.push_hktprodu_status_writer == None):
                ...
                title = "market_type, security_code, orig_time, " + \
                        "trading_status1, trading_status2, variety_category\n"
    ...
    def PushMDHKTVCMToCsv(self, data):
        try:
            if(self.push_hkt_vcm_writer == None):
                ...
                title = "market_type, security_code, orig_time, " + \
                        "start_time, end_time, ref_price, low_price, high_price, variety_category\n"
                self.push_hkt_vcm_writer.WriteTitle(title)
            
            data_str =  str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                        str(data.start_time)+ "," + str(data.end_time)+ "," + str(data.ref_price)+ "," + \
                        str(data.low_price)+ "," + str(data.high_price)+ "," + str(data.variety_category)+ "\n"
        ...
        try:
            if(self.push_snapshot_deriver_writer == None):
                ...
                title = "market_type, security_code, orig_time, average_price, " + \
                        ...
                        "PE_TTM, PB, entrustment_diff, initiative_flag, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                    ...
                    str(data.initiative_flag)+ "," + str(data.variety_category)+ "\n" 
        ...
        try:
            if(self.push_kline_writer_map[kline_type] == None):
                ...
                title = "market_type, security_code, orig_time, " + \
                        ...
                        "close_price, volume_trade, value_trade, variety_category\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.orig_time)+ "," + \
                        ...
                        str(data.volume_trade)+ "," + str(data.value_trade)+ "," + str(data.variety_category)+ "\n" 
        ...
        try:
            if(self.query_tick_excution_writer == None):
                ...
                title = "market_type, security_code, exec_time, channel_no, appl_seq_num, " + \
                        ...
                        "md_stream_id, biz_index, variety_category, cancel_flag\n"
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + str(data.exec_time)+ "," + \
                        ...
                        str(data.biz_index)+ "," + str(data.variety_category) + "," + str(data.cancel_flag) + "\n"
    ...
    def QueryMDOptionSnapshotToCsv(self, data):
        try:
            ...
            data_str = str(data.market_type)+ "," + str(data.security_code)+ "," + \
                    ...
                    str(data.underlying_security_code)+ "," + str(data.exercise_price)+ "," + str(data.variety_category)+ "\n" 
    ...
    def QueryMDOrderSnapshotToCsv(self, data):
        try:
            if(self.query_order_snapshot_writer == None):
                self.query_order_snapshot_writer = DataWriter(self.dir,"HKExOrderSnapshot.csv")
                title = "market_type, security_code, orig_time, operation, bid_list, ask_list\n"
                self.query_order_snapshot_writer.WriteTitle(title)
            
            operation = ""
            bid_list = ""
            ask_list = ""
            operation += (str(data.operation.operation_type) + "_" + str(data.operation.order_id) + "_" +\
                str(data.operation.side) + "_" + str(data.operation.order_type) + "_" +\
                str(data.operation.order_price) + "_" + str(data.operation.order_volume))
            for i in range(20):
                bid_list_temp = tgw.Tools_GetMDHKExListItemByIndex(data.bid_list, i)
                bid_list += (str(bid_list_temp.order_price) + "_" + str(bid_list_temp.order_volume) + "_" +\
                     str(bid_list_temp.num_of_orders) + "|")
            bid_list = bid_list[:len(bid_list) -1]

            for i in range(20):
                ask_list_temp = tgw.Tools_GetMDHKExListItemByIndex(data.bid_list, i)
                ask_list += (str(ask_list_temp.order_price) + "_" + str(ask_list_temp.order_volume) + "_" +\
                     str(ask_list_temp.num_of_orders) + "|")
            ask_list = ask_list[:len(ask_list) -1]
            ...
            data_str = str(data.market_type) + "," + \
                    ...
                    bid_list + "," + \
                    ask_list + "\n"
            self.query_order_snapshot_writer.WriteData(data_str)
        except Exception as error:
            print('QueryMDFutureSnapshotToCsv exception:' + str(error))

    def QueryMDOrderBrokerSnapshotToCsv(self, data):
        try:
            if(self.query_order_broker_snapshot_writer == None):
                self.query_order_broker_snapshot_writer = DataWriter(self.dir,"HKExOrderBrokerSnapshot.csv")
                title = "market_type, security_code, orig_time, side, broker_flag, detail\n"
                self.query_order_broker_snapshot_writer.WriteTitle(title)
            
            detail = ""
            for i in range(40):
                detail_temp = tgw.Tools_GetMDHKExDetailItemByIndex(data.detail, i)
                detail += (str(detail_temp.level) + "_" + str(detail_temp.broker_num) + "|")
            ...
            data_str = str(data.market_type) + "," + \
                    ...
                    str(data.orig_time) + "," + \
                    str(data.side) + "," + \
                    str(data.broker_flag) + "," + \
                    detail + "\n"
            self.query_order_broker_snapshot_writer.WriteData(data_str)
        except Exception as error:
            print('QueryMDFutureSnapshotToCsv exception:' + str(error))
